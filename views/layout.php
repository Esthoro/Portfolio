    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <li><a href="/public/assets/pdf/cv.pdf" target="_blank">Mon CV</a></li>
            </ul>
        </nav>

        <div class="position-relative">
                <a href="/mon-compte/" class="mx-2"><span class="bi-person"></span></a>
        ...
        <div class="container">
            ...
            <div class="row g-5">
                <div class="col-lg-4">
                    ...
                    <p><a href="/about/" class="footer-link-more">En savoir plus</a></p>
                </div>
                <div class="col-6 col-lg-2">
                    ...
                    <ul class="footer-links list-unstyled">
                        ...
                        <li><a href="/about/"><i class="bi bi-chevron-right"></i> A propos</a></li>
                        <li><a href="/contact/"><i class="bi bi-chevron-right"></i> Contact</a></li>
                        <li><a href="/public/assets/pdf/cv.pdf" target="_blank"><i class="bi bi-chevron-right"></i> CV</a></li>
                    </ul>
                </div>
                <div class="col-6 col-lg-2">
                    <h3 class="footer-heading">Espace perso</h3>
                    <ul class="footer-links list-unstyled">
                        <li><a href="/mon-compte/"><i class="bi bi-chevron-right"></i> Mon compte</a></li>
                        <li><a href="/admin/"><i class="bi bi-chevron-right"></i> Administration</a></li>
                    </ul>
                </div>
                ...
                <div class="col-lg-4">
                    ...
                    <ul class="footer-links footer-blog-entry list-unstyled">
                        ...
                        <li>
                            <a href="/singlePost/<?= $postFooter->id; ?>/" class="d-flex align-items-center">
                                <div>
